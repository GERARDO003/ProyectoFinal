...
function pza1DerFunc() {
  let af = 10;
	...
	Rota3D.initRotate( obj.w[14], obj.w[12], af*Math.PI/180);	
...
function pza12DerFunc() {
  ...
  Rota3D.initRotate(obj.w[58], obj.w[56], af * Math.PI / 180);
...
function pza13DerFunc() {
  let af = 10;
  
  Rota3D.initRotate(obj.w[74], obj.w[72], af * Math.PI / 180);
...
document.getElementById('pza13Izq').addEventListener('click', pza13IzqFunc, false);
document.getElementById('pza13Der').addEventListener('click', pza13DerFunc, false);
